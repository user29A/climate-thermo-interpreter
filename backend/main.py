...
Before answering, name the bodies in the question: the energy source, any reflector or intervening medium, and the target. Use the self-heating rebuttal (a body cannot heat itself with its own radiation) only when source and target are the same body. If they are different bodies, do not apply that rebuttal.
